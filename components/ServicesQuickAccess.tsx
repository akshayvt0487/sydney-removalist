...
const ServicesQuickAccess = () => {
  ...
  return (
    <section className="py-8 bg-gradient-to-r from-primary via-navy to-primary">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          {/* Glassmorphism container */}
          <div className="bg-white/95 backdrop-blur-sm rounded-full shadow-2xl p-4 flex items-center justify-between gap-4 flex-wrap md:flex-nowrap">
            
            {/* Service Buttons Loop */}
