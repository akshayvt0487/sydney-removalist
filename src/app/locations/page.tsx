...
export const metadata = createMetadata({
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: `${SEO_CONFIG.baseUrl}/og-locations.jpg`, width: 1200, height: 630, alt: "Sydney Removalist Service Areas Map" }]
  },
  twitter: {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {interstateList.map((destination: any) => (
                  <Link 
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start space-x-4 bg-background p-4 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-foreground">Central Coast</h3>
                    <p className="text-sm text-muted-foreground">Gosford, Terrigal, Wyong, and surrounding areas</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 bg-background p-4 rounded-lg">
                  <svg className="w-6 h-6 text-secondary flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-foreground">Blue Mountains</h3>
                    <p className="text-sm text-muted-foreground">Katoomba, Penrith, Richmond, and mountain towns</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 bg-background p-4 rounded-lg">
                  <svg className="w-6 h-6 text-secondary flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-foreground">Wollongong</h3>
                    <p className="text-sm text-muted-foreground">Illawarra region and South Coast areas</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 bg-background p-4 rounded-lg">
                  <svg className="w-6 h-6 text-secondary flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-foreground">Newcastle</h3>
                    <p className="text-sm text-muted-foreground">Hunter Valley and Northern NSW regions</p>
                  </div>
                </div>
              </div>
            </div>
