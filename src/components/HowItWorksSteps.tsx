...
import stepQuote from '@/assets/family-quote.jpg';
import stepBooking from '@/assets/step-booking.jpg';
import stepMoving from '@/assets/step-moving.jpg';
    ...
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
          ...
          {steps.map((step, index) => (
            <div key={index} className="text-center animate-fade-in-up" style={{ animationDelay: `${index * 0.2}s` }}>
              <div className="relative mb-6">
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-12 bg-secondary text-white rounded-full flex items-center justify-center font-bold text-xl shadow-lg">
                  {index + 1}
                </div>
              </div>
        ...
        <div className="text-center">
          <Link 
            href="/contact" 
            className="inline-flex items-center justify-center px-8 py-4 bg-secondary text-white font-semibold rounded-lg hover:bg-secondary/90 transition-colors"
          >
            Get Started Today
          </Link>
        </div>
