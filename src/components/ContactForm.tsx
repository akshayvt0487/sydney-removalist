        ...
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-card p-8 rounded-lg shadow-lg">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-accent text-accent-foreground py-3 rounded-md font-semibold text-lg hover:bg-accent/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
