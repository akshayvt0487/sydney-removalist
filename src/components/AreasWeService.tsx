      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {featuredAreas.map((area, index) => {
            ...
            return (
            <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 border border-white/20 animate-fade-in-up hover:scale-105 hover:shadow-xl" style={{ animationDelay: `${index * 0.1}s` }}>
              ...
              <Link href={`/locations#${slug}`} className="text-accent hover:text-accent/80 font-semibold inline-flex items-center gap-2 group">
                View Details
