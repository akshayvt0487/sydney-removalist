      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">
            Simple, Honest Removalist Rates
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            No hidden fees. No surprises. Just competitive rates for quality service.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-2 text-muted-foreground bg-muted/50 px-4 py-2 rounded-full">
            ...
            <p className="text-sm">All prices include GST, fuel, and tolls</p>
          </div>
        </div>
      </div>
    </section>
