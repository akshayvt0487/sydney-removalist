...
import movingAppScreen from '@/assets/moving-app-screen.jpg';
            ...
            <div className="relative z-10 mx-auto max-w-xs">
              <div className="bg-charcoal rounded-[3rem] p-4 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <div className="bg-white rounded-[2.5rem] overflow-hidden">
                  <div className="aspect-[9/19] bg-charcoal flex items-center justify-center">
                    <Image 
                      src={movingAppScreen} 
                      alt="Sydney Removalist moving app interface showing booking options"
