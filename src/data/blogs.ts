...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription: 'Find out how much removalists cost in Sydney in 2024. Complete pricing guide with rates from $60/half hour. Compare costs by home size and get tips to save money on your move.',
    ...
    content: [
      ...
      },
      {
        type: 'list',
        items: [
          'Hourly rates: Typically $60-$150 per half hour depending on team size',
