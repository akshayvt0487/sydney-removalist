export const faqData = [
  {
    ...
    answer: "Our rates start from $60 per 1/2 hr + GST for 2 removalists with a 4.5T truck (1 bedroom home). The final cost depends on factors like the size of your home, distance, amount of items, and any additional services required. We provide free, no-obligation quotes to give you an accurate estimate."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer: "Yes, we operate 7 days a week including weekends and most public holidays. Please note that a small surcharge (typically 15%) applies to weekend and holiday moves."
  },
  {
    id: 4,
