// Suburbs organized by regions for mega menu and location pages
...
export const interstateDestinations = [
  {
...
export const getSuburbsByRegion = (regionSlug) => {
  const region = regionCategories.find(r => r.slug === regionSlug);
  return region ? region.suburbs : [];
};

// Get suburb details
export const getSuburbDetails = (suburbSlug) => {
